...
const TUTORIAL_STEPS: TutorialStep[] = [
    ...
    },
    {
        ...
        description: 'Hold the habit text to edit it, or tap the shuffle button to try a different one from your deck.',
        position: 'top',
        emoji: '✏️',
        color: 'purple',
    },
    ...
    },
    {
        ...
        title: 'Focus Tools',
        description: 'Turn on ambient sounds for focus, or tap the mic to log reflections with your voice.',
        position: 'left',
        emoji: '🎵',
        color: 'blue',
    },
