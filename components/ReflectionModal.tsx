            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="bg-white dark:bg-dark-800 w-full max-w-md p-6 rounded-3xl shadow-2xl pointer-events-auto relative max-h-[85vh] overflow-y-auto"
                    >
                        ...
                        <div className="flex justify-between gap-2 mb-6">
                            {(['low', 'medium', 'high'] as EnergyLevel[]).map((level) => (
                                <button
                                    ...
                                    className={`flex-1 py-4 rounded-2xl border-2 transition-all ${energy === level
